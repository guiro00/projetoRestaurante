    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
          ...
          <div class="row">
            <div class="col-md-12">  
              <div class="form-group">
               <center> <label for="categoria-name" class="form-control-label">Nome da categoria :</center></label>
        ...
        <div class="modal-footer">
          ...
          <button type="submit" class="btn btn-primary" name="agregarCategorias">Adicionar categoria</button>
          </form>
        </div>
      </div>
    </div>
