...
<?php 
 ...
 ?>
    <ol class="breadcrumb">
      <li class="breadcrumb-item active"><i class="fa fa-list"> </i> VENDAS DIÁRIAS</li>
   </ol>
<!-- Nav tabs -->
<ul class="nav nav-tabs" role="tablist">
  <li class="nav-item">
    <a class="nav-link " id="uno" data-toggle="tab" href="#home" role="tab">Consultar por datas</a>
  </li>
  <li class="nav-item">
            ...
            <div class="col-md-6">
               <table class="table table-bordered">
                 <thead class="bg-danger">
                     <tr>
                         <td class="td" align="center"> TOTAL DE VENDAS </td>
                         <td class="td" align="center"> QUANTIDADE DE PRODUTOS  </td>
                         <td class="td" align="center"> USUARIO DO SISTEMA  </td>
                     </tr>
                 </thead>
