...
<div class="container">
  ...
  <ol class="breadcrumb">
     <li class="breadcrumb-item active"><i class="fa fa-list"> </i> EDITAR USUÁRIOS </li>
  </ol>
 <form method="post">
 <?php foreach ($consulta as $key ): ?>
    <input type="hidden" name="idproducto" value="<?php echo $key['idproducto']; ?>">
          ...
          <div class="row">
            <div class="col-md-6">  
              <div class="form-group">
               ...
               <div class="col-md-6">  
             <div class="form-group">
              <label for="recipient-name" class="form-control-label">Categoria de Produtos:</label>
      <select class="form-control chosen-select" id="idcategoria" name="idcategoria">     
         ...
         <CENTER>
            <button type="submit" class="btn btn-primary" name="editarProductos">Adicionar Produtos</button>
         </CENTER>
         <br>
       </form>
 <?php endforeach ?>
