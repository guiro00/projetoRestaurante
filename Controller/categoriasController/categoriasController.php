...
class CategoriasController {
  ...
  echo'  <div class="col-md-8">  
              ...
              <label for="categoria-name" class="form-control-label">Nome da categoria :</label>
        ...
        <input type="hidden" name="idcategoria" value="'.$respuesta['idcategoria'].'">
          <button type="submit" class="btn btn-primary" name="editarCategorias">Editar a categoria</button>
          </div>
   <div class="col-md-4">
